                ...
                <div>
                    <form className="space-y-2">
                        <div>
                            ...
                            <input name="desc" type="text" id="title" className="w-full px-4 py-2 rounded-md focus:outline-none border border-slate-300 mt-1 focus:border-green-500" placeholder="Write Todo Title" />
                        </div>
                        <div>
                            <label htmlFor="desc" className="text-slate-700 block">Todo Description</label>
                            <textarea name="desc" id="desc" rows="5" className="w-full px-4 py-2 rounded-md focus:outline-none border border-slate-300 mt-1 focus:border-green-500 resize-none" placeholder="Write Todo Description"></textarea>
                        </div>
